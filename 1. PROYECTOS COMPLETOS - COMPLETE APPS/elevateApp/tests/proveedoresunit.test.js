...
describe('Pruebas unitarias Proveedores', () => {

    test('Se debe mostrar el listado de Proveedores de forma exitosa', async () => {
    ...
    test('Se deben envíar los formularios de registro y edición Proveedores de forma exitosa al servidor', async () => {
      const response = await request(app).get('/auth/404');
      expect(response.statusCode).toBe(200);
    });

    test('Se debe mostrar el modal de detalles del Proveedor de forma exitosa', async () => {

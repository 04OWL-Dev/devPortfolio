...
describe('Pruebas unitarias Ventas', () => {

    test('Se debe mostrar el listado de Ventas de forma exitosa', async () => {
    ...
    test('Se deben envíar los formularios de registro y edición Ventas de forma exitosa al servidor', async () => {
      const response = await request(app).get('/auth/404');
      expect(response.statusCode).toBe(200);
    });

    test('Se debe mostrar el modal de detalles de la Venta de forma exitosa', async () => {

...
describe('Pruebas unitarias Usuarios', () => {
    ...
    test('Se debe mostrar el listado de Usuarios de forma exitosa', async () => {
    ...
    test('Se deben envíar los formularios de registro y edición Usuarios de forma exitosa al servidor', async () => {
      const response = await request(app).get('/auth/404');
      expect(response.statusCode).toBe(200);
    });

    test('Se debe mostrar el modal de detalles del Usuario de forma exitosa', async () => {

...
const productosController = {
  ...
  eliminarProducto: async (codigo) => {    
    try {
        await pool.query(`DELETE FROM public.productos WHERE codigo = ${codigo}`);  
